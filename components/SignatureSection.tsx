          ...
          >
            ...
            >
              ...
              <div className="space-y-1 px-2">
                ...
                <h3 className="text-sm md:text-base font-sans font-bold text-surface-on group-hover:text-primary transition-colors tracking-tight line-clamp-1">{product.name}</h3>
